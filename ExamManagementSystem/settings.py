...
SECRET_KEY = 'django-insecure-50#eg*ag5^2nj4s#hlx15(m+!xi*6+cb05lr%l6ata46n(8w$u'
...
JAZZMIN_UI_TWEAKS = {
    "css": {
        "custom": "css/admin.css",  # Path to your custom CSS file
    }
}
JAZZMIN_SETTINGS["copyright"] = "online exam © 2025"
...
LOGIN_URL = '/teacher/teacherlogin/'
LOGIN_REDIRECT_URL='/' 
